...
{
    public partial class EditForum : uDebateThreadsModuleBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            //else if (HttpContext.Current.Session["CurrentUserInfo"] != null)
        ...
        protected void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (New != String.Empty)
                {
                    if (New.ToUpper() == "FORUM")
                    {
                        SQL = String.Format(@"INSERT INTO uDebate_forums(description, summary, active, created_by, updated_by, status) 
                                              VALUES ({0}description, {0}summary, {1}, {2}, {2}, 1)", ATC.Database.Sql_VariableIdent, (activeChk.Checked ? "1" : "0"), CurrentUserID);
                        ...
                        Response.Redirect("forums_edit.aspx?edit=forum&forumid=" + ForumID);
                    }
                    else if (New.ToUpper() == "TOPIC")
                    {
